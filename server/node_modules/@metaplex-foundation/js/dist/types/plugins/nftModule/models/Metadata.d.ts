import { ProgrammableConfig, TokenStandard, UseMethod } from '@metaplex-foundation/mpl-token-metadata';
import { PublicKey } from '@solana/web3.js';
import { MetadataAccount } from '../accounts';
import { JsonMetadata } from './JsonMetadata';
import { Option } from '../../../utils';
import { BigNumber, Creator, Pda, ReadApiCompressionMetadata } from '../../../types';
/** @group Models */
...
export declare const isNonFungible: (nftOrSft: {
    tokenStandard: Option<TokenStandard>;
}) => boolean;
export declare const isProgrammable: (nftOrSft: {
    tokenStandard: Option<TokenStandard>;
}) => boolean;
