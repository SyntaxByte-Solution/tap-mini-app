 ...
 * @category Types
 */
export type WithdrawFromBuyerAccountOperation = Operation<typeof Key, WithdrawFromBuyerAccountInput, WithdrawFromBuyerAccountOutput>;
/**
 * @group Operations
 * @category Inputs
 */
 ...
 * @category Inputs
 */
export type WithdrawFromBuyerAccountBuilderParams = Omit<WithdrawFromBuyerAccountInput, 'confirmOptions'> & {
 ...
 * @category Contexts
 */
export type WithdrawFromBuyerAccountBuilderContext = Omit<WithdrawFromBuyerAccountOutput, 'response'>;
/**
