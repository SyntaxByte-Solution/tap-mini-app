...
export declare class NftClient {
    ...
    create(input: CreateNftInput, options?: OperationOptions): Promise<import("./operations").CreateCompressedNftOutput>;
    ...
    delegate(input: ApproveNftDelegateInput, options?: OperationOptions): Promise<import("./operations").ApproveNftDelegateOutput>;
    /** {@inheritDoc revokeNftDelegateOperation} */
    revoke(input: RevokeNftDelegateInput, options?: OperationOptions): Promise<import("./operations").RevokeNftDelegateOutput>;
    ...
    lock(input: LockNftInput, options?: OperationOptions): Promise<import("./operations").LockNftOutput>;
    /** {@inheritDoc unlockNftOperation} */
    unlock(input: UnlockNftInput, options?: OperationOptions): Promise<import("./operations").UnlockNftOutput>;
    /** {@inheritDoc mintNftOperation} */
    mint(input: MintNftInput, options?: OperationOptions): Promise<import("./operations").MintNftOutput>;
    /** {@inheritDoc transferNftOperation} */
    transfer(input: TransferNftInput, options?: OperationOptions): Promise<import("./operations").TransferNftOutput>;
