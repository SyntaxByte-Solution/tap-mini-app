...
export declare function delegateLockedTransferV1(context: Pick<Context, 'eddsa' | 'identity' | 'payer' | 'programs'>, input: DelegateLockedTransferV1InstructionAccounts & DelegateLockedTransferV1InstructionArgs): TransactionBuilder;
