...
export declare function revokeProgrammableConfigV1(context: Pick<Context, 'eddsa' | 'identity' | 'payer' | 'programs'>, input: RevokeProgrammableConfigV1InstructionAccounts & RevokeProgrammableConfigV1InstructionArgs): TransactionBuilder;
