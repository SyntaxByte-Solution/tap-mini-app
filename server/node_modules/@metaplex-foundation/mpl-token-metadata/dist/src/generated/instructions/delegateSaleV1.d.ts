...
export declare function delegateSaleV1(context: Pick<Context, 'eddsa' | 'identity' | 'payer' | 'programs'>, input: DelegateSaleV1InstructionAccounts & DelegateSaleV1InstructionArgs): TransactionBuilder;
